# -*- coding: utf-8 -*-
# @Time    : 2026/3/15 00:51
# @Author  : 陈宇杰（CHEN YUJIE）
# @File    : analyze_weight_results.py
...
if __name__ == "__main__":
    ...
    result_dict_1 = {
        ...
        "w1": "../data/result_w1_epoch8/DICM/42.jpg",
        "w3": "../data/result_w3_epoch8/DICM/42.jpg",
        "w5": "../data/result_w5_epoch8/DICM/42.jpg",
    }
    ...
    result_dict_2 = {
        ...
        "w1": "../data/result_w1_epoch8/DICM/01.jpg",
        "w3": "../data/result_w3_epoch8/DICM/01.jpg",
        "w5": "../data/result_w5_epoch8/DICM/01.jpg",
    }
    ...
    result_dict_3 = {
        ...
        "w1": "../data/result_w1_epoch8/DICM/37.jpg",
        "w3": "../data/result_w3_epoch8/DICM/37.jpg",
        "w5": "../data/result_w5_epoch8/DICM/37.jpg",
    }

    analyze_one_group(input_path_1, result_dict_1, "../csv/weight_scene1.csv")
    analyze_one_group(input_path_2, result_dict_2, "../csv/weight_scene2.csv")
    analyze_one_group(input_path_3, result_dict_3, "../csv/weight_scene3.csv")