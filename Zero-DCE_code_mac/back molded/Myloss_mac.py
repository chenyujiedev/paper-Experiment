...
# 新增：暗区域加权曝光损失
# 说明：
# 1. tau：暗区阈值，低于 tau 的区域才被重点看作暗区
# 2. gamma：暗区强调系数，越大越强调特别暗的地方
# 3. target_mean：暗区增强后的目标曝光值
# =========================================================
class DarkRegionExposureLoss(nn.Module):
    def __init__(self, patch_size=16, target_mean=0.6, tau=0.5, gamma=2.0):
    ...
    def forward(self, input_img, enhanced_img):
        ...
        # patch-level 平均，和原始 L_exp 风格保持一致
