# -*- coding: utf-8 -*-
# @Time    : 2026/3/14 21:12
# @Author  : 陈宇杰（CHEN YUJIE）
# @File    : lowlight_dark_train_mac.py
...
if __name__ == "__main__":
    ...
    # 光源保护参数
    # =========================================================
    parser.add_argument("--highlight_loss_weight", type=float, default=0.03)
    parser.add_argument("--highlight_patch_size", type=int, default=8)
    parser.add_argument("--highlight_tau", type=float, default=0.9)
    parser.add_argument("--highlight_beta", type=float, default=1.5)
    parser.add_argument("--highlight_margin", type=float, default=0.04)
