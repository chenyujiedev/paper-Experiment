...
# LOL-v1
python3 Enhancement/test_from_dataset.py --opt Options/result_retinex_v1.yml --weights pretrained_weights/LOL_v1.pth --dataset LOL_v1
...
```shell
# LOL-v1
python3 Enhancement/test_from_dataset.py --opt Options/result_retinex_v1.yml --weights pretrained_weights/LOL_v1.pth --dataset LOL_v1 --GT_mean
...
# LOL-v1
python3 basicsr/train.py --opt Options/result_retinex_v1.yml
